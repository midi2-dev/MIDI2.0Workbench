...
namespace NodeRT { namespace Windows { namespace Devices { namespace Midi2 { 
  ...
  static void InitMidiSendMessageResultEnum(const Local<Object> exports) {
    ...
    Nan::Set(enumObject, Nan::New<String>("success").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::Success)));
    Nan::Set(enumObject, Nan::New<String>("errorBufferFull").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorBufferFull)));
    Nan::Set(enumObject, Nan::New<String>("errorInvalidMessageTypeForWordCount").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorInvalidMessageTypeForWordCount)));
    Nan::Set(enumObject, Nan::New<String>("errorInvalidMessageOther").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorInvalidMessageOther)));
    Nan::Set(enumObject, Nan::New<String>("errorSendDataIndexOutOfRange").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorSendDataIndexOutOfRange)));
    Nan::Set(enumObject, Nan::New<String>("errorEndpointConnectionClosedOrInvalid").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorEndpointConnectionClosedOrInvalid)));
    Nan::Set(enumObject, Nan::New<String>("errorUnexpected").ToLocalChecked(), Nan::New<Integer>(static_cast<int>(::Windows::Devices::Midi2::MidiSendMessageResult::ErrorUnexpected)));
  }
 ...
 //   }
  ...
  class MidiEndpointDeviceInformation : public WrapperBase {
    public:
      ...
      static void Init(const Local<Object> exports) {
        ...
        localRef->InstanceTemplate()->SetInternalFieldCount(1);
            ...
            Nan::SetAccessor(localRef->PrototypeTemplate(), Nan::New<String>("uniqueIdentifier").ToLocalChecked(), UniqueIdentifierGetter);
    ...
    static void FunctionBlocksGetter(Local<String> property, const Nan::PropertyCallbackInfo<v8::Value> &info) {
      ...
      try  {
        ::Windows::Foundation::Collections::IVectorView<::Windows::Devices::Midi2::MidiFunctionBlock^>^ result = wrapper->_instance->FunctionBlocks;
        info.GetReturnValue().Set(NodeRT::Collections::VectorViewWrapper<::Windows::Devices::Midi2::MidiFunctionBlock^>::CreateVectorViewWrapper(result, 
    ...
    static void UniqueIdentifierGetter(Local<String> property, const Nan::PropertyCallbackInfo<v8::Value> &info) {
      HandleScope scope;
      ...
      try  {
        Platform::String^ result = wrapper->_instance->UniqueIdentifier;
        info.GetReturnValue().Set(NodeRT::Utils::NewString(result->Data()));
        return;
      } catch (Platform::Exception ^exception) {
        NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
